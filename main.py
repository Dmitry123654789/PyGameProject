...
class Game:
    ...
    def add_group_sprite(self):
        self.player = Player((screen.get_size()[0] / 2, screen.get_size()[1] / 2), split_image(load_image('images/dog_sprites.png'), 32, CELL_SIZE), self.player_group)
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.WINDOWRESIZED:
                    self.player.update_player_rect()
