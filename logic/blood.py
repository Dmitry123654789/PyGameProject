...
def get_sprites(img):
    sprites = []
    for x in range(6):
        sprites.append(pygame.transform.scale(img.subsurface(pygame.rect.Rect(32 * x, 0, 32, 32)), (CELL_SIZE, CELL_SIZE)))
    return sprites


class Blood(pygame.sprite.Sprite):
    sprites = get_sprites(load_image('images/blood_2.png'))
