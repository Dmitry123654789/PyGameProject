...
class Player(Entity):
    ...
    sprites = split_image(load_image('images\\dog_sprites\\player.png'), 32, CELL_SIZE * 2)
    attack_sprites = split_image(load_image('images\\dog_sprites\\attack_player.png'), 32, CELL_SIZE * 2)
